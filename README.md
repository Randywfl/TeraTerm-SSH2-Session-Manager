...
Password feature only keeps the pswd for you in each respective session.  The pasasword is posted to your clipboard when you click [Connect].  Best I could do since Tera Term does not allow credentials to be passed to the client for auto-login.  I recently added a checkbox that allows the user to disable the clipboard option.  If you're like me, you fid it nearly impossib;l eto find a download link anywhere io GitHub so here is the URL for direct doenload from gitHub:

- TeraTerm is a Very Fine SSH Client for general professional use. The main weakness is lacking the ability to save your sessions as you go. There is a Very lame "menu" companion app that I was never able to get working so I decided to create my own session manager. It is somewhat limited in that it only works for SSH2 sessions, but that is all I needed.
  
  Now the Obsolete original SSHTTSM On Steroids
- # 3-Way Client Session Manager
  
  ** New International friendly Session names are now possible as of version 3.0 release.
...
- ## Creating a Session
  ...
  1. Enter the:
	- **Session Name** (Any Language)
	- **IP Address** (IPv4)
	- **Port** (default: 22)
	  
	  2. (Optional) Enter a **Username** and **Password** (Ascii only)
...
- ## Connecting to a Session
  ...
  1. Choose the preferred client:
	- **Tera Term**
		- Select User customized Macro if desired and available
...
- ## Balloon Tips default\*\* (version 2.2 & higher)\*\*
...
- Right Click your 3-Way_CSM shortcut.
- Click properties
